...
Built on the Junk-Store framework, this fork adds six store/library integrations and a large set of quality-of-life features on top of the original Epic Games support.

**Current release: v1.1.7** — see [Releases](https://github.com/Starkka15/GameVault/releases).
...
5. Open the plugin, go to **About → Install Dependencies** to pull the runtimes needed by GOG, Amazon, EA Play, and RPG Maker.
...
### Community Fork
- **Starkka15** — GOG, Amazon, itch.io, RPG Maker (native), and EA Play extensions; itch.io Collections; GOG DLC manager; My Added Games; cloud save sync; SteamGridDB integration + artwork scan; GE-Proton installer; protonfixes lookup/apply; storage management; batch install queue; update detection
